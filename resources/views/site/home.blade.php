...
<div class="hero v2 section-padding" style="background-image: url({{ asset('site/assets/images/header/hero_1.jpg')}})">
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 col-sm-12">
                            <div class="input-search">
                                <input type="text" name="place-event" id="place-event" placeholder="Insira o Imóvel, Cidade ou Bairro ...">
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-6 col-sm-12 pl-0">
                            <select class="hero__form-input form-control custom-select" multiple title="Selecionar Estado">
                        ...
                        <div class="col-xl-3 col-lg-6 col-sm-12 pl-0">
                            ...
                            <div class="dropdown-filter"><span>Busca Avançada </span></div>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 py-1 pr-30 pl-0">
                                    <div class="filter-sub-area style1">
                                        <div class="filter-title mb-10">
                                            <p>Preço : <span><input type="text" id="amount_two"></span></p>
                                        </div>
...
<div class="property-place pb-60 hideme" style="background-image: url({{ asset('site/assets/images/bg/map-bg-1.png')}})">
    <div class="container">
        <div class="row">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_5.jpg')}}" alt="place-image"></a>
                            <a class="single-place-title" href="location-left-sidebar.html">Miami</a>
                        </div>
                    ...
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_1.jpg')}}" alt="place-image"></a>
                    ...
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_4.jpg')}}" alt="place-image"></a>
                    ...
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_16.jpg')}}" alt="place-image"></a>
                    ...
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_2.jpg')}}" alt="place-image"></a>
                            <a class="single-place-title" href="location-left-sidebar.html">Havana</a>
                        </div>
                        <div class="single-place-content">
                    ...
                    <div class="swiper-slide single-place-wrap">
                        <div class="single-place-image">
                            <a href="location-left-sidebar.html"><img src="{{ asset('site/assets/images/places/place_6.jpg')}}" alt="place-image"></a>
                            <a class="single-place-title" href="location-left-sidebar.html">Oklahoma</a>
                        </div>
                        <div class="single-place-content">
        ...
        <div class="featured-property-wrap v1 swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="featured-property-item bg-h" style="background-image: url({{ asset('site/assets/images/featured/featured_5.jpg')}});">
                        <div class="container">
                            <div class="row">
                ...
                <div class="swiper-slide">
                    <div class="featured-property-item bg-h" style="background-image: url({{ asset('site/assets/images/featured/featured_6.jpg')}});">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div class="featured-property-info">
                ...
                <div class="swiper-slide">
                    <div class="featured-property-item bg-h" style="background-image: url({{ asset('site/assets/images/featured/featured_3.jpg')}});">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div class="featured-property-info">
                    ...
                    <div class="tab-pane fade show active" id="all_property">
                        <div class="row">
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_1.jpg')}}" alt="#">
                                        </a>
                                        ...
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agent_min_1.jpg')}}" alt="...">
                                            ...
                                            <div class="hidden photo-gallery">
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_1.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_2.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_3.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_4.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_5.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_6.jpg')}}"></a>
                                                <a href="{{ asset('site/assets/images/single-listing/property_view_7.jpg')}}"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="property-title-box">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_3.jpg')}}" alt="#"></a>
                                        <ul class="feature_text">
                                            <li class="feature_or"><span>For Rent</span></li>
                                        </ul>
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agency_2.jpg')}}" alt="...">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_6.jpg')}}" alt="#"></a>
                                        <ul class="feature_text">
                                        ...
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agent_min_2.jpg')}}" alt="...">
                                                <span>Bob Haris</span>
                                            </a>
                                            <ul class="save-btn">
                    ...
                    <div class="tab-pane fade" id="for_sale">
                        <div class="row">
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_4.jpg')}}" alt="#"></a>
                                        <ul class="feature_text">
                                            <li class="feature_cb"><span> Featured</span></li>
                                            <li class="feature_or"><span>For Sale</span></li>
                                        </ul>
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agency_4.jpg')}}" alt="...">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_5.jpg')}}" alt="#">
                                        </a>
                                        <ul class="feature_text">
                                            <li class="feature_or"><span>For Sale</span></li>
                                        </ul>
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agency_3.jpg')}}" alt="...">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_1.jpg')}}" alt="#"></a>
                                        <ul class="feature_text">
                                            <li class="feature_cb"><span> Featured</span></li>
                                            <li class="feature_or"><span>For Sale</span></li>
                                        </ul>
                    ...
                    <div class="tab-pane fade" id="for_rent">
                        <div class="row">
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_7.jpg')}}" alt="#"> </a>
                                        <ul class="feature_text">
                                            <li class="feature_cb"><span> Featured</span></li>
                                            <li class="feature_or"><span>For Rent</span></li>
                                        </ul>
                                        <div class="property-author-wrap">
                                            <a href="#" class="property-author">
                                                <img src="{{ asset('site/assets/images/agents/agency_1.jpg')}}" alt="...">
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12">
                                <div class="single-property-box">
                                    <div class="property-item">
                                        <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_8.jpg')}}" alt="#"> </a>
                                        <ul class="feature_text">
                                            <li class="feature_cb"><span> Featured</span></li>
                                            <li class="feature_or"><span>For Rent</span></li>
                                        </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12">
                <div class="value-img bg-h" style="background-image: url({{ asset('site/assets/images/property/property_val.jpg')}})">
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
            ...
            <div class="swiper-container trending-place-wrap">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="single-property-box">
                            <div class="property-item">
                                <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_9.jpg')}}" alt="#"> </a>
                                <ul class="feature_text">
                                    <li class="feature_cb"><span>New</span></li>
                                    <li class="feature_or"><span>For Sale</span></li>
                                </ul>
                                <div class="property-author-wrap">
                                    <a href="#" class="property-author">
                                        <img src="{{ asset('site/assets/images/agents/agent_min_3.jpg')}}" alt="...">
                                        <span>Jim Carry</span>
                                    </a>
                                    <ul class="save-btn">
                                        <li data-toggle="tooltip" data-placement="top" title="Video"><a href="https://www.youtube.com/watch?v=v_ATnE02qFs" class="property-yt"><i class="fas fa-play"></i></a></li>
                    ...
                    <div class="swiper-slide">
                        <div class="single-property-box">
                            <div class="property-item">
                                <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_2.jpg')}}" alt="#"> </a>
                                <ul class="feature_text">
                                    <li class="feature_cb"><span>New</span></li>
                                    <li class="feature_or"><span>For Rent</span></li>
                                </ul>
                    ...
                    <div class="swiper-slide">
                        <div class="single-property-box">
                            <div class="property-item">
                                <a class="property-img" href="single-listing-two.html"><img src="{{ asset('site/assets/images/property/property_5.jpg')}}" alt="#"> </a>
                                <ul class="feature_text">
                                    <li class="feature_cb"><span>New</span></li>
                                    <li class="feature_or"><span>For Sale</span></li>
                                </ul>
                    ...
                    <div class="col-md-12">
                        <div class="promo-content-wrap">
                            <div class="promo-content">
                                <img src="{{ asset('site/assets/images/category/pin.png')}}" alt="...">
                                <h4>Personalized Service.</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid cumque</p>
                            </div>
                            <div class="promo-content">
                                <img src="{{ asset('site/assets/images/category/rent.png')}}" alt="...">
                                <h4>Financing made easy.</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid cumque.</p>
                            </div>
                            <div class="promo-content">
                                <img src="{{ asset('site/assets/images/category/customer_support.png')}}" alt="...">
                                <h4>24/7 support.</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid cumque.</p>
                            </div>
                            <div class="promo-content">
                                <img src="{{ asset('site/assets/images/category/deal.png')}}" alt="...">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="single-testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="testimonial-video" style="background-image: url({{ asset('site/assets/images/testimonial/testimonial-2.jpg')}})">
                                            <div class="overlay op-2"></div>
                        ...
                        <div class="swiper-slide">
                            <div class="single-testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="testimonial-video" style="background-image: url({{ asset('site/assets/images/testimonial/testimonial-5.jpg')}})">
                                        </div>
                                    </div>
                                    <div class="testimonial-quote">
                        ...
                        <div class="swiper-slide">
                            <div class="single-testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="testimonial-video" style="background-image: url({{ asset('site/assets/images/testimonial/testimonial-7.jpg')}})">
...
<div class="call-to-action bg-fixed bg-h mt-4 consult-form v1" style="background-image: url({{ asset('site/assets/images/bg/call-to-action-bg.jpg')}})">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="single-team-member v2">
                                <a href="single-agent.html"><img src="{{ asset('site/assets/images/agents/agent_1.jpg')}}" alt="Image"></a>
                        ...
                        <div class="swiper-slide">
                            <div class="single-team-member v2">
                                <a href="single-agent.html">
                                    <img src="{{ asset('site/assets/images/agents/agent_2.jpg')}}" alt="Image">
                                </a>
                                <div class="single-team-info">
                        ...
                        <div class="swiper-slide">
                            <div class="single-team-member v2">
                                <a href="single-agent.html"><img src="{{ asset('site/assets/images/agents/agent_3.jpg')}}" alt="Image"></a>
                                <div class="single-team-info">
                        ...
                        <div class="swiper-slide">
                            <div class="single-team-member v2">
                                <a href="single-agent.html"><img src="{{ asset('site/assets/images/agents/agent_4.jpg')}}" alt="Image"></a>
                                <div class="single-team-info">
                        ...
                        <div class="swiper-slide">
                            <div class="single-team-member v2">
                                <a href="single-agent.html"><img src="{{ asset('site/assets/images/agents/agent_8.jpg')}}" alt="Image"></a>
                                <div class="single-team-info">
